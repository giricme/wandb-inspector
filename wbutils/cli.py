...
Examples:
  ...
  wbutils export my-entity my-project --metrics accuracy --output results.csv
    ...
    plot_parser.add_argument("project", nargs="?", default=None, help="Wandb project name (optional if using --project)")
    ...
    for label, inspector in inspectors.items():
        for metric in metrics:
            if not inspector.has_history(metric):
                ...
                print(f"Run first: wbutils history {inspector.entity} {inspector.project} --metric {metric}")
                return
